...
class ComponentsControllerTest < ActionController::TestCase
  ...
  test "should create component" do
    assert_difference('Component.count') do
      post :create, component: { amount: @component.amount, dish_id: @component.dish_id, ingredient_id: @component.ingredient_id, units: @component.units }
    end
  ...
  test "should update component" do
    patch :update, id: @component, component: { amount: @component.amount, dish_id: @component.dish_id, ingredient_id: @component.ingredient_id, units: @component.units }
    assert_redirected_to component_path(assigns(:component))
  end
