...
class MeasureUnitsControllerTest < ActionController::TestCase
  ...
  test "should create measure_unit" do
    assert_difference('MeasureUnit.count') do
      post :create, measure_unit: { nonstandard_name: @measure_unit.nonstandard_name, quantity_in_standard: @measure_unit.quantity_in_standard, standard_name: @measure_unit.standard_name }
    end
  ...
  test "should update measure_unit" do
    patch :update, id: @measure_unit, measure_unit: { nonstandard_name: @measure_unit.nonstandard_name, quantity_in_standard: @measure_unit.quantity_in_standard, standard_name: @measure_unit.standard_name }
    assert_redirected_to measure_unit_path(assigns(:measure_unit))
  end
